...
//       {/* Legend */}
//       <div className="mb-4 pdf-legend">
//         <div className="flex flex-wrap gap-2">
//           <span className="text-sm text-slate-600 font-medium">Course Types:</span>
//           {Object.entries({
//             Major: "bg-blue-50 border-blue-200 text-blue-800",
//             Minor: "bg-green-50 border-green-200 text-green-800",
//             "Value-Added": "bg-orange-50 border-orange-200 text-orange-800",
...
//       <div className="pdf-timetable-grid">
//         <div className="grid grid-cols-[100px_repeat(5,1fr)] gap-2 mb-2">
//           <div></div>
//           {days.map((day) => (
//             <div
//               key={day}
//               className="text-center py-3 font-semibold text-slate-700 bg-slate-100 rounded-lg pdf-day-header"
//             >
//               {day}
//             </div>
//           ))}
...
//         <div className="grid grid-cols-[100px_repeat(5,1fr)] gap-2 pdf-grid-content">
//           {timeSlots.map((time, rowIndex) => (
//             <Fragment key={rowIndex}>
//               <div className="flex items-center justify-center py-4 font-medium text-slate-600 bg-indigo-50 rounded-lg pdf-time-slot">
//                 {time}
//               </div>
...
//                   <div
//                     key={colIndex}
//                     className="min-h-[80px] bg-white border border-slate-200 rounded-lg p-2 hover:bg-slate-50 transition-colors pdf-cell"
//                   >
//                     {classInSlot ? (
//                       <div
//                         className={`h-full rounded-md border p-3 ${classInSlot.color} shadow-sm pdf-class-card`}
//                       >
//                         <div className="font-semibold text-sm mb-2 leading-tight pdf-course-name">
//                           {classInSlot.courseName}
//                         </div>
//                         <div className="text-xs space-y-1 pdf-class-details">
//                           <div className="pdf-faculty">👨‍🏫 {classInSlot.faculty}</div>
//                           <div className="pdf-room">🏫 {classInSlot.room}</div>
//                           {/* <div className="pdf-course-type text-xs opacity-75">
//                             {classInSlot.courseType}
//                           </div> */}
//                         </div>
//                       </div>
//                     ) : (
//                       <div className="h-full flex items-center justify-center text-slate-400 text-sm pdf-free-slot">
//                         Free
//                       </div>
//                     )}
//                   </div>
...
//   const [exportMethod, setExportMethod] = useState("visual"); // "visual" or "table"
...
//   };
  ...
  //       className="rounded-2xl border border-slate-200 bg-white shadow-xl p-6 pdf-container"
  //     >
  //       {showAllPrograms ? (
  //         <div>
  ...
  //       ) : selectedProgram ? (
  //         <div>
  //           <div className="mb-4 text-center pdf-header">
    ...
    <div className="pdf-timetable-section">
      ...
      <div className="pdf-timetable-grid bg-white rounded-lg shadow-md border overflow-hidden">
        ...
        <div className="pdf-grid-content">
          {timeSlots.map((time, rowIndex) => (
            <div key={rowIndex} className="grid grid-cols-[80px_repeat(5,1fr)] min-h-[80px] border-b border-slate-200 last:border-b-0">
