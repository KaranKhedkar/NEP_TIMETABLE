...
//             <button
//               type="submit"
//               className="w-full rounded-md bg-indigo-600 py-2 text-sm font-medium text-white shadow hover:bg-indigo-700 transition"
//             >
//               Sign In
//             </button>
//           </form>
...
//           <button
//             type="button"
//             className="w-full flex justify-center items-center gap-2 rounded-md border border-slate-300 bg-white py-2 text-sm font-medium text-slate-800 hover:border-indigo-500 transition"
//           >
